...
export function AnalyticsView({ workspace }: WorkspaceProps) {
  ...
  return (
    <div className="analytics-view view-stack"><header className="page-intro"><div><span className="eyebrow"><BarChart3 size={14} /> ANALYTICS REAIS</span><h1>Esforço que vira domínio</h1><p>Os gráficos usam somente suas sessões, revisões e evidências — sem números decorativos.</p></div></header>
      <section className="analytics-kpis"><article><Clock3 size={19} /><span>Horas focadas</span><strong>{totalHours.toFixed(1)}h</strong><small>{workspace.sessions.length} sessões</small></article><article><Target size={19} /><span>Ementa verde</span><strong>{green}/72</strong><small>{Math.round(green / 72 * 100)}% dominado</small></article><article><MessageCircleQuestion size={19} /><span>Sabatina boa+</span><strong>{successfulSabatina}</strong><small>de {workspace.sabatinaAttempts.length} tentativas</small></article><article><FolderGit2 size={19} /><span>Projetos</span><strong>{Object.values(workspace.projectStatus).filter((s) => s === "publicado").length}/22</strong><small>publicados</small></article></section>
