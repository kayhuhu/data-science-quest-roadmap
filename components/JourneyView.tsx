    ...
    <div className="view-stack journey-view">
      ...
      <section className="roadmap-layout">
        ...
        <aside className="current-mission-card">
          ...
          <div className="mission-checklist"><span><BookOpen size={15} /> {currentWeek.content.length} tópicos</span><span><MessageCircleQuestion size={15} /> {currentWeek.sabatina.length} perguntas</span><span><FolderGit2 size={15} /> {currentWeek.project.title}</span></div>
